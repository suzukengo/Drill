<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<body bgcolor="#FFA07A" style="margin: 0px;">
		...
		<div style="margin-left: 200px; margin-right: 200px;">
			<h1 style="margin-top: 30px; font-size: 30px; font-weight: 200; text-decoration: underline; text-underline-offset: 8px;">利用者登録</h1>
				<form action="./RegistInfok" method="post" style="margin-left: 100px; margin-right: 100px; margin-top: 50px; margin-bottom: 50px;
				 ...
				 display: flex; flex-direction: column; justify-content: space-between; align-items: center;">
					...
					<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; margin-top: 20px;">
						<font size="5">　　　名前：</font><br />
						<input required type="text" name="name"  style="width: 300px; height: 28px; padding-left: 10px; margin-left: 50px;" />
					</div>
