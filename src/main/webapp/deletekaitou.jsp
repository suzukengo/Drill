		...
		<div style="margin-left: 200px; margin-right: 200px;">
			...
			<form action="RegistMondai" method="post" style="margin-left: 100px; margin-right: 100px; margin-top: 50px; margin-bottom: 50px;
				...
				<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; margin-top: 10px;">
					...
					<input required type="passwords" name="pass" style="width: 300px; height: 28px; padding-left: 10px; margin-left: 50px;" />
				</div>
				<input type="submit" value="削除" style="padding: 5px; margin-top: 30px; width: 100px;"/>
			</form>
		</div>
	</body>
</html>