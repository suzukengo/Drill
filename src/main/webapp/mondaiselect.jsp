<%@ page contentType="text/html;charset=UTF-8"
	...
	<body bgcolor="#FFA07A" style="margin: 0px;">
		...
		<div style="margin-left: 200px; margin-right: 200px;">
			<h1 style="margin-top: 30px; font-size: 30px; font-weight: 200; text-decoration: underline; text-underline-offset: 8px;">問題検索</h1>
				<form action="./SearchMondai" method="post" style="margin-left: 100px; margin-right: 100px; margin-top: 50px; margin-bottom: 50px;
